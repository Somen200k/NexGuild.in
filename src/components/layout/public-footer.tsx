          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Telegram"
                className="h-8 w-8 rounded-md flex items-center justify-center border border-[var(--border-default)] text-[var(--text-muted)] hover:text-[#229ED9] hover:border-[#229ED9] transition-colors"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-[var(--text-secondary)] hover:text-[#229ED9] transition-colors"
                >
                  Telegram
                </a>
              </li>
