...
export const metadata: Metadata = { title: "How It Works — NexGuild for Organizations" };
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4">
                  ...
                  <Link
                    href="/contact"
                    className="h-12 px-8 inline-flex items-center rounded-xl border border-[var(--brand-500)] text-[var(--brand-500)] text-base font-semibold hover:bg-[var(--brand-100)] transition-colors"
                  >
                    Contact Form
                  </Link>
                </div>
