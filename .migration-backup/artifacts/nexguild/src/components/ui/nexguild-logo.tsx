...
export function NexGuildLogo({
  ...
  if (variant === "landing") {
    return (
      ...
      >
        <svg width={180} height={95} viewBox="0 0 180 95" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  if (variant === "navbar") {
    return (
      ...
      >
        {/* SVG inlined — no inner component refs, safe across all build optimisations */}
        <svg width="42" height="40" viewBox="0 0 42 40" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  return (
    <Link
      ...
      style={{ display: "inline-flex", flexShrink: 0, textDecoration: "none" }}
    >
      <svg width={190} height={55} viewBox="0 0 240 70" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <text x="102" y="32" fontFamily="Arial, sans-serif" fontWeight="900" fontSize="26" fill="#ffffff">
          Nex<tspan fill={accent}>Guild</tspan>
        </text>
        <line x1="102" y1="42" x2="237" y2="42" stroke={accent} strokeWidth="0.6" opacity="0.35"/>
        <text x="102" y="56" fontFamily="Arial, sans-serif" fontWeight="300" fontSize="7" fill={accent} letterSpacing="3" opacity="0.75">
          DIGITAL WORKFORCE
        </text>
      </svg>
    </Link>
