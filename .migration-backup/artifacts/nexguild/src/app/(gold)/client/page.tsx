        ...
        <div className="relative z-10 mx-auto max-w-container px-6 pt-28 pb-20 text-center">
          ...
          <FadeIn delay={300}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/contact"
                className="w-full sm:w-auto h-12 px-8 inline-flex items-center justify-center rounded-xl bg-[var(--brand-500)] text-[var(--text-inverse)] text-base font-bold hover:bg-[var(--brand-400)] transition-all duration-200 hover:scale-105 hover:shadow-[0_0_32px_rgba(245,158,11,0.4)]"
              >
                Get a Quote →
              </Link>
              <a
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full sm:w-auto h-12 px-8 inline-flex items-center justify-center gap-2 rounded-xl bg-[#229ED9] text-white text-base font-semibold hover:opacity-90 transition-all duration-200 hover:scale-105"
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full sm:w-auto h-12 px-8 inline-flex items-center justify-center rounded-xl border border-[var(--brand-500)] text-[var(--brand-500)] text-base font-semibold hover:bg-[var(--brand-100)] transition-all duration-200"
                  >
                    Send Email
                  </a>
                </div>
